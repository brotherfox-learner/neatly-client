...
async function onSubmit() {
  ...
  try {
    ...
    authError.value = error instanceof Error ? error.message : "Register failed."
  } finally {
    ...
    <section class="mx-auto w-full max-w-[1440px] lg:relative lg:min-h-[1542px]">
      ...
      <section class="w-full px-[16px] py-[40px] lg:absolute lg:left-1/2 lg:top-[60px] lg:w-[min(1092px,100%)] lg:-translate-x-1/2 lg:p-0">
        <section class="bg-background flex flex-col items-start gap-[40px] lg:gap-[60px] lg:rounded-[4px] lg:p-[80px] lg:shadow-[4px_4px_16px_rgba(0,0,0,0.08)]">
          ...
          <form class="flex w-[343px] flex-col gap-[24px] lg:w-full lg:gap-[40px]" @submit.prevent="onSubmit">
            ...
            <section class="grid w-full grid-cols-1 gap-[24px] lg:grid-cols-2 lg:gap-x-[40px] lg:gap-y-[40px]">
              <section class="flex w-full flex-col gap-[4px]">
                ...
                <input id="first-name" v-model="firstName" type="text" placeholder="Enter your first name" class="body-1 text-gray-900 placeholder:text-gray-600 border-gray-400 h-[48px] w-full rounded-[4px] border bg-white px-[12px] pr-[16px] outline-none focus:border-gray-500" required />
              </section>
              <section class="flex w-full flex-col gap-[4px]">
                <label class="body-1 text-gray-900 h-[24px]" for="last-name">Last name</label>
                <input id="last-name" v-model="lastName" type="text" placeholder="Enter your last name" class="body-1 text-gray-900 placeholder:text-gray-600 border-gray-400 h-[48px] w-full rounded-[4px] border bg-white px-[12px] pr-[16px] outline-none focus:border-gray-500" required />
              </section>
              <section class="flex w-full flex-col gap-[4px]">
              ...
              <section class="flex w-full flex-col gap-[4px]">
                ...
                <input id="register-email" v-model="email" type="email" autocomplete="email" placeholder="Enter your email" class="body-1 text-gray-900 placeholder:text-gray-600 border-gray-400 h-[48px] w-full rounded-[4px] border bg-white px-[12px] pr-[16px] outline-none focus:border-gray-500" required />
              </section>
              <section class="flex w-full flex-col gap-[4px]">
                <label class="body-1 text-gray-900 h-[24px]" for="register-password">Password</label>
                <input id="register-password" v-model="password" type="password" autocomplete="new-password" placeholder="Enter your password" class="body-1 text-gray-900 placeholder:text-gray-600 border-gray-400 h-[48px] w-full rounded-[4px] border bg-white px-[12px] pr-[16px] outline-none focus:border-gray-500" required />
              </section>
              <section class="flex w-full flex-col gap-[4px]">
                <label class="body-1 text-gray-900 h-[24px]" for="register-confirm-password">Confirm password</label>
                <input id="register-confirm-password" v-model="confirmPassword" type="password" autocomplete="new-password" placeholder="Confirm your password" class="body-1 text-gray-900 placeholder:text-gray-600 border-gray-400 h-[48px] w-full rounded-[4px] border bg-white px-[12px] pr-[16px] outline-none focus:border-gray-500" required />
              </section>
              <section class="flex w-full flex-col gap-[4px]">
