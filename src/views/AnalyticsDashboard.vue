...
const roomMockData = {
  month: [
    { id: 'occupied',  label: 'Occupied',  count: 12, percent: 40, color: 'bg-orange-500', strokeColor: '#e76b39' },
    { id: 'booked',    label: 'Booked',    count: 8,  percent: 27, color: 'bg-green-700',  strokeColor: '#465c50' },
    { id: 'available', label: 'Available', count: 10, percent: 33, color: 'bg-gray-500',   strokeColor: '#c8ccdb' },
  ],
  week: [
    { id: 'occupied',  label: 'Occupied',  count: 15, percent: 50, color: 'bg-orange-500', strokeColor: '#e76b39' },
    { id: 'booked',    label: 'Booked',    count: 6,  percent: 20, color: 'bg-green-700',  strokeColor: '#465c50' },
    { id: 'available', label: 'Available', count: 9,  percent: 30, color: 'bg-gray-500',   strokeColor: '#c8ccdb' },
  ],
  day: [
    { id: 'occupied',  label: 'Occupied',  count: 20, percent: 67, color: 'bg-orange-500', strokeColor: '#e76b39' },
    { id: 'booked',    label: 'Booked',    count: 4,  percent: 13, color: 'bg-green-700',  strokeColor: '#465c50' },
    { id: 'available', label: 'Available', count: 6,  percent: 20, color: 'bg-gray-500',   strokeColor: '#c8ccdb' },
  ],
}
    ...
    <div class="lg:flex lg:flex-col lg:w-full">
      ...
      <main class="flex flex-col bg-gray-100 gap-[24px] lg:px-[60px] lg:py-[40px] pb-[119px]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-[24px] lg:gap-[8px]">
          <section class="rounded-[8px] border border-gray-300 p-[16px] lg:py-[24px] lg:px-[40px] bg-white">
