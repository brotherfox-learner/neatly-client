...
const dashboardStats = [
  { key: 'totalBooking',      label: 'Total Booking',       value: 76,    percentChange: 52,   trend: 'up',   type: 'number' },
  { key: 'totalSales',        label: 'Total Sales',         value: 58829, percentChange: 17.7, trend: 'up',   type: 'currency', currency: 'THB' },
  { key: 'totalBookingUsers', label: 'Total Booking Users', value: 66,    percentChange: -2.9, trend: 'down', type: 'number' },
  { key: 'totalSiteVisitors', label: 'Total site visitors', value: 459,   percentChange: 8.5,  trend: 'up',   type: 'number' },
]
...
const roomMockData = {
  month: [
    { id: 'occupied',  label: 'Occupied',  count: 12, percent: 40, color: 'bg-orange-500', strokeColor: 'var(--orange-500)' },
    { id: 'booked',    label: 'Booked',    count: 8,  percent: 27, color: 'bg-green-700',  strokeColor: 'var(--green-700)' },
    { id: 'available', label: 'Available', count: 10, percent: 33, color: 'bg-gray-500',   strokeColor: 'var(--gray-500)' },
  ],
  week: [
    { id: 'occupied',  label: 'Occupied',  count: 15, percent: 50, color: 'bg-orange-500', strokeColor: 'var(--orange-500)' },
    { id: 'booked',    label: 'Booked',    count: 6,  percent: 20, color: 'bg-green-700',  strokeColor: 'var(--green-700)' },
    { id: 'available', label: 'Available', count: 9,  percent: 30, color: 'bg-gray-500',   strokeColor: 'var(--gray-500)' },
  ],
  day: [
    { id: 'occupied',  label: 'Occupied',  count: 20, percent: 67, color: 'bg-orange-500', strokeColor: 'var(--orange-500)' },
    { id: 'booked',    label: 'Booked',    count: 4,  percent: 13, color: 'bg-green-700',  strokeColor: 'var(--green-700)' },
    { id: 'available', label: 'Available', count: 6,  percent: 20, color: 'bg-gray-500',   strokeColor: 'var(--gray-500)' },
  ],
}
...
<template>
  <div class="flex flex-col lg:flex-row">
    ...
    <div class="lg:flex lg:flex-col lg:w-full">
      <header class="flex h-[80px] bg-white border-b border-gray-300 px-[16px] lg:px-[60px] lg:py-[16px] items-center">
      ...
      <main class="flex flex-col bg-gray-100 gap-[24px] lg:px-[60px] lg:py-[40px] pb-[119px]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-[24px] lg:gap-[8px]">
          <section class="rounded-[8px] border border-gray-300 p-[16px] lg:pt-[24px] lg:px-[40px] lg:pb-[24px] bg-white">
